...
const mockServiceData = {
    1: {
        id: 1,
        mainPhoto: nrmendfsystems,
        //name: 'Clínica Bem-Estar',
        //segment: 'Restaurante',
        //description: '',
        hours: 'Seg-Sex: 08:00-18:00',
        menuServices: [
            { id: 1, name: 'Autisconnect', description: 'Plataforma inovadora desenvolvida especialmente para crianças com autismo, ela integra pais, profissionais de saúde, educadores e serviços locais em um só lugar, oferecendo suporte personalizado, monitoramento de emoções, e recursos adaptados para o dia a dia..' },
            { id: 2, name: 'StoreControl', description: 'Gerencie seu negócio com eficiência usando o StoreControl, um software completo para controle de vendas, estoque, clientes, fornecedores, cotações e muito mais!' },
        ],
        certificates: [
            { id: 1, name: 'Certificado de Inclusão Autisconnect 2024' },
            { id: 2, name: 'Selo Ambiente Amigo do Autista' },
        ],
        address: 'Rua das Coimbra, 405, Nossa Senhora do Ó, Paulista-PE',
        coordinates: [-7.8833862704362145, -34.83660530380349],
        contact: {
            phone: '(81) 98254-0904',
            whatsapp: '(81) 98254-0904',
            socialMedia: {
                //facebook: 'https://facebook.com/clinicabemestar',
                instagram: 'https://instagram.com/segredosdasabundancias',
            },
        },
        feedbacks: [
