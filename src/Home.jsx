...
import {
    ...
    const [features] = useState([
        ...
        },
        {
            ...
            link: "/PresentationProfessionalDashboard", // ← agora aponta para a sua página linda!
            color: "#3498db"
        },
        {
            id: 4,
            ...
            link: "/PresentationParentDashboard", // ← agora vai direto pra sua página linda!
            color: "#9b59b6"
        },
        {
            id: 5,
            ...
            link: "/presentation-dashboard/PresentationSecretaryDashboard", // ← agora aponta para sua página linda!
            color: "#1abc9c"
        },
        {
            id: 6,
                ...
                <Col lg={6} className="mb-5 mb-lg-0">
                    ...
                    <div className="d-flex flex-wrap gap-3 mt-4">
                        ...
                        <Link to="/login" className="text-decoration-none"
                            onClick={() => {
                                localStorage.removeItem('token');  // ← limpa o login atual
